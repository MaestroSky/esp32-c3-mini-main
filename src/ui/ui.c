...
///////////////////// VARIABLES ////////////////////
lv_anim_t * LogoAnim_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * TextAnim_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * Pogoda_Animation(lv_obj_t * TargetObject, int delay);
...
lv_anim_t * TextAnim_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_playback_time(&PropertyAnimation_0, 0);
    lv_anim_set_playback_delay(&PropertyAnimation_0, 0);
    lv_anim_set_repeat_count(&PropertyAnimation_0, 3000);
    lv_anim_set_repeat_delay(&PropertyAnimation_0, 0);
    lv_anim_set_early_apply(&PropertyAnimation_0, true);

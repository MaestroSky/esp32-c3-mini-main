...
const Translations t_uk = { "Налаштування годинника", "Налаштування годинника", "Українська", "English", "Базові налаштування", "Назва мережі Wi-Fi (SSID)", "Пароль Wi-Fi", "Ключ API для погоди", "Персоналізація", "Місто для погоди", "MAC-адреса для Wake-on-LAN", "Часовий пояс", "Автоматичний перехід на літній час", "Зберегти і перезавантажити" };
const Translations t_en = { "Watch Settings", "Watch Settings", "Українська", "English", "Basic Settings", "Wi-Fi Network Name (SSID)", "Wi-Fi Password", "Weather API Key", "Personalization", "City for Weather", "MAC Address for Wake-on-LAN", "Timezone", "Enable Daylight Saving Time", "Save and Reboot" };
